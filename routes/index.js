...
router.get('/fff', function (req, res, next) {
    ...
    res.render('site/fff', {title: 'Baja La Bruja - F#$ck Fast Fashion', messages: messages,
...
router.get('/labruja', function (req, res, next) {
    var messages = req.flash('info');
    res.render('site/labruja', {title: 'Baja La Bruja - F#ck Fast Fashion', messages: messages,
    hasMessages: messages.length > 0});
});
